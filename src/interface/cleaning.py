...
def convert_obs_params_from_ecef_to_eci(obs_params: ObsParams) -> ObsParams:
    """
    ...
    obs_params.position = ecef_to_eci(obs_params.position, obs_params.epoch)
    return obs_params


def convert_obs_params_from_lla_to_eci(obs_params: ObsParams) -> ObsParams:
    """
